#ifndef WBC_PY_ROBOT_MODEL_RBDL_HPP
#define WBC_PY_ROBOT_MODEL_RBDL_HPP

#include <wbc/robot_models/rbdl/RobotModelRBDL.hpp>
...
class RobotModelRBDL : public wbc::RobotModelRBDL{
public:
