...
namespace wbc_py{
    VelocitySceneQP::VelocitySceneQP(std::shared_ptr<wbc::RobotModelPinocchio> robot_model, std::shared_ptr<wbc::QPOASESSolver> solver, const double dt) : 
...
BOOST_PYTHON_MODULE(velocity_scene_qp){
    ...
    py::class_<wbc_py::VelocitySceneQP>("VelocitySceneQP", py::init<std::shared_ptr<wbc::RobotModelPinocchio>, std::shared_ptr<wbc::QPOASESSolver>, const double>())
